...
public class WISTestHandler : TestHandler
{
    public List<WISTestItem> testItemFrontEnd;
    public WISTestItem frontEndItem;
    ...
    public void CreateTest(WISTestItem t)
    {
        ...
        for (int i = 0; i < t.LetterButtons.Length; i++)
        {
            ...
            o.GetComponent<ClickCardWIS>().isCorrect = t.isCorrect[i];
            o.GetComponent<ClickCardWIS>().responsePosition = i + 1;
            o.GetComponent<ClickCardWIS>().responseName = t.wordPictures[i].name;
    ...
    public void LoadNextTest()
    {
        if (!testItemFrontEnd[currentTestNumber].skipPrint)
            WISOutputHandler.StopTimer(testAbbrev, testItemFrontEnd[currentTestNumber].id);
        DeletePrevTest();
        currentTestNumber++;
        //currEvent = 0;
    ...
    public void SortItems()
    {
        ...
        foreach (WISTestItem l in testItemFrontEnd)
        {
            posValues.Add(l.pos);
            print(l.pos);
        }
