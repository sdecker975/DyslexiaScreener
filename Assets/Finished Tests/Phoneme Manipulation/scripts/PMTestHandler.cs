...
public class PMTestHandler : TestHandler
{

    public List<PMTestItem> testItemFrontEnd;
    public PMTestItem frontEndItem;
    ...
    public void CreateTest(PMTestItem t)
    {
        ...
        for (int i = 0; i < t.LetterButtons.Length; i++)
        {
            ...
            o.GetComponent<ClickCardPM>().isCorrect = t.isCorrect[i];
            o.GetComponent<ClickCardPM>().responsePosition = i + 1;
            o.GetComponent<ClickCardPM>().responseName = t.wordPictures[i].name;
    ...
    public void LoadNextTest()
    {
        if (!testItemFrontEnd[currentTestNumber].skipPrint)
            PMOutputHandler.StopTimer(testAbbrev, testItemFrontEnd[currentTestNumber].id);
        DeletePrevTest();
        currentTestNumber++;
        //currEvent = 0;
    ...
    public void SortItems()
    {
        ...
        foreach (PMTestItem l in testItemFrontEnd)
        {
            posValues.Add(l.pos);
            print(l.pos);
        }
