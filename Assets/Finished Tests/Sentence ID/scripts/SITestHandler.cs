...
public class SITestHandler : TestHandler
{

    public List<SITestItem> testItemFrontEnd;
    public SITestItem frontEndItem;
    ...
    public void CreateTest(SITestItem t)
    {
        ...
        for (int i = 0; i < t.LetterButtons.Length; i++)
        {
                ...
                o.GetComponent<ClickCardSI>().isCorrect = t.isCorrect[i];
                o.GetComponent<ClickCardSI>().responsePosition = i + 1;
                o.GetComponent<ClickCardSI>().responseName = t.wordPictures[i].name;
    ...
    public void LoadNextTest()
    {
        if (!testItemFrontEnd[currentTestNumber].skipPrint)
            SIOutputHandler.StopTimer(testAbbrev, testItemFrontEnd[currentTestNumber].id);
        DeletePrevTest();
        currentTestNumber++;
        //currEvent = 0;
    ...
    public void SortItems()
    {
        ...
        foreach (SITestItem l in testItemFrontEnd)
        {
            posValues.Add(l.pos);
            print(l.pos);
        }
