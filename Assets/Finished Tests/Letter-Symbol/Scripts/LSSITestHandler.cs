...
public class LSSITestHandler : TestHandler
{
    public List<LSSITestItem> testItemFrontEnd;
    public LSSITestItem frontEndItem;
    ...
    public void CreateTest(LSSITestItem t)
    {
        ...
        //    LSSIOutputHandler.StartTimer(0);
    }
    ...
    public void LoadNextTest()
    {
        if (!testItemFrontEnd[currentTestNumber].skipPrint)
            LSSIOutputHandler.StopTimer(testAbbrev, testItemFrontEnd[currentTestNumber].id);
        DeletePrevTest();
        currentTestNumber++;
        //currEvent = 0;
    ...
    public void SortItems()
    {
        ...
        foreach (LSSITestItem l in testItemFrontEnd)
        {
            posValues.Add(l.pos);
            print(l.pos);
        }
