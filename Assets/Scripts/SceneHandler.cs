...
public class SceneHandler : MonoBehaviour
{
    ...
    public static string[] abbrevs = { "LI", "LSSI", "WI", "SI", "RC", "RF", "OV", "OC", "SLC", "RYM", "SB", "PM", "LF", "RAN", "RLNN", "RLNL", "RLNM", "VWM", "VWMB", "VIS", "CSC", "CSS", "CSA", "WCST", "WIS", "end", "Bender" };
    public static bool[] sceneActive =  { true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true };
